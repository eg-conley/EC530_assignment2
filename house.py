...
@router.post("/house")
def create_house(house_id: int, name: str, address: str, gps: dict, owner: dict, occupants: list[dict]):
...
def update_house(house_id: int, name: str, address: str, gps: dict, owner: dict, occupants: list[dict]):
